...
Foam::scalar Foam::ISATleaf<CompType, ThermoType>::tolerance_;

// * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * * //

template<class CompType, class ThermoType>
void Foam::ISATleaf<CompType, ThermoType>::qrDecompose
(
    const label nCols,
...
template<class CompType, class ThermoType>
void Foam::ISATleaf<CompType, ThermoType>::qrUpdate
(
    scalarSquareMatrix& R,
    const label n,
...
template<class CompType, class ThermoType>
void Foam::ISATleaf<CompType, ThermoType>::rotate
(
    scalarSquareMatrix& R,
    const label i,
    const scalar a,
...
template<class CompType, class ThermoType>
Foam::ISATleaf<CompType, ThermoType>::ISATleaf
(
    ...
    ISATNode<CompType, ThermoType>* node
)
:
...
Foam::ISATleaf<CompType, ThermoType>::ISATleaf
(
    Foam::ISATleaf<CompType, ThermoType>& p
)
:
...
template<class CompType, class ThermoType>
bool Foam::ISATleaf<CompType, ThermoType>::inEOA(const scalarField& phiq)
{
...
template<class CompType, class ThermoType>
bool Foam::ISATleaf<CompType, ThermoType>::checkSolution
(
...
template<class CompType, class ThermoType>
bool Foam::ISATleaf<CompType, ThermoType>::grow(const scalarField& phiq)
{
    scalarField dphi(phiq - phi());
...
template<class CompType, class ThermoType>
void Foam::ISATleaf<CompType, ThermoType>::increaseNumRetrieve()
{
    this->numRetrieve_++;
}
...
template<class CompType, class ThermoType>
void Foam::ISATleaf<CompType, ThermoType>::resetNumRetrieve()
{
    this->numRetrieve_ = 0;
}
...
template<class CompType, class ThermoType>
void Foam::ISATleaf<CompType, ThermoType>::increaseNLifeTime()
{
    this->nLifeTime_++;
}
...
template<class CompType, class ThermoType>
Foam::label Foam::ISATleaf<CompType, ThermoType>::
