...
Foam::speciesTable& Foam::HYfoamChemistryReader<ThermoType>::setSpecies
(
...
template<class ThermoType>
void Foam::HYfoamChemistryReader<ThermoType>::readSpeciesComposition()
{
...
template<class ThermoType>
Foam::HYfoamChemistryReader<ThermoType>::HYfoamChemistryReader
(
