...
#include "XYYmultiComponentMixture.H"

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //


template<class ThermoType>
const Foam::thermotable<ThermoType>& Foam::XYYmultiComponentMixture<ThermoType>::constructSpeciesData
(
...
template<class ThermoType>
void Foam::XYYmultiComponentMixture<ThermoType>::correctMassFractions()
{
...
template<class ThermoType>
Foam::XYYmultiComponentMixture<ThermoType>::XYYmultiComponentMixture
(
    const dictionary& thermoDict,
...
template<class ThermoType>
const Foam::thermotable<ThermoType>& Foam::XYYmultiComponentMixture<ThermoType>::cellMixture
(
    const label celli
) const
{
...
template<class ThermoType>
const Foam::thermotable<ThermoType>& Foam::XYYmultiComponentMixture<ThermoType>::patchFaceMixture
(
    const label patchi,
    const label facei
) const
...
template<class ThermoType>
const Foam::thermotable<ThermoType>& Foam::XYYmultiComponentMixture<ThermoType>::cellVolMixture
(
    const scalar p,
    const scalar T,
    const label celli
...
template<class ThermoType>
const Foam::thermotable<ThermoType>& Foam::XYYmultiComponentMixture<ThermoType>::
patchFaceVolMixture
(
    const scalar p,
    const scalar T,
...
template<class ThermoType>
void Foam::XYYmultiComponentMixture<ThermoType>::read
(
    const dictionary& thermoDict
)
{
