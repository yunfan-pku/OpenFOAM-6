...
Foam::HYreactingMixture<ThermoType>::HYreactingMixture
(
...
:
    ...
    HYmultiComponentMixture<ThermoType>//XYY
    (
        thermoDict,
        *this,
...
template<class ThermoType>
void Foam::HYreactingMixture<ThermoType>::read(const dictionary& thermoDict)
{}
